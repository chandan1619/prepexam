                  ...
                  courses.slice(0, 3).map((course) => (
                    <div
                      ...
                      className={`group bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-blue-200 transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02] ${
                        courses.slice(0, 3).length === 1 ? 'max-w-md w-full' : ''
                      }`}
                    >
                      {course.imageUrl ? (
            ...
            {[
              {
                ...
                answer: "This course is designed for BPSC TRE 4.0 (Computer Science) and Bihar STET (Computer Science) exams, covering the complete latest syllabus."
              },
              {
                question: "What do I get in this course?",
                answer: "You get written notes, topic-wise explanations, solved examples, previous year questions, and practice questions — all in an easy-to-understand, exam-oriented format."
              },
              {
                question: "How long do I get access?",
                answer: "You get lifetime access, including free updates whenever the syllabus or exam pattern changes."
              },
              {
                question: "Do you offer free demo content?",
                answer: "Yes! We provide sample notes so you can check the quality before purchasing."
              },
              {
                question: "Can I ask doubts if I get stuck?",
                answer: "Yes, we offer Telegram/WhatsApp group support where you can get your doubts solved quickly."
              },
              {
                question: "Is this course enough to crack the exam?",
                answer: "If you follow the course seriously and practice regularly, it will be more than enough to clear the exam confidently."
              }
            ].map((faq, index) => (
              <div
                key={index}
