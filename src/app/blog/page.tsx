            ...
            <>
              ...
              <div className="mt-16 bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl p-12 text-center text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/exams">
                    <button className="bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer">
                      Explore Courses
                    </button>
                  </Link>
                  <Link href="/dashboard">
